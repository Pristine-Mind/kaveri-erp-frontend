  ...
  return (
    <div className="min-h-screen bg-gray-100 p-4 sm:p-8">
      <div className="flex flex-col sm:flex-row justify-between items-center mb-4">
        <h2 className="text-2xl font-bold mb-4 sm:mb-0">{t('supplier_list')}</h2>
        <input
          type="text"
          value={searchQuery}
        ...
        <div className="flex space-x-2">
          ...
          >
            <FaPlus className="mr-2" /> {t('add_supplier')}
          </button>
          <button
      ...
      <div className="overflow-x-auto relative shadow-md sm:rounded-lg mb-8">
        <table className="w-full text-sm text-left text-gray-500">
          <thead className="text-xs text-gray-700 uppercase bg-gray-50">
            <tr>
              <th scope="col" className="py-3 px-6">{t('supplier_name')}</th>
            ...
            <div className="relative bg-white rounded-lg shadow-xl p-8 w-full max-w-lg z-20">
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="flex justify-end space-x-4">
                  ...
                  >
                    {editingProducerId ? t('update_supplier') : t('add_supplier')}
                  </button>
                </div>
              </form>
            </div>
